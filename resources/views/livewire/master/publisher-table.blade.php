        ...
        <table class="data-table">
            ...
            <tbody>
                @forelse($publishers as $index => $publisher)
                    <tr>
                        <td class="text-slate-500">{{ $publishers->firstItem() + $index }}</td>
                        <td class="font-medium text-slate-800">{{ $publisher->name }}</td>
                        <td>{{ $publisher->books_count }} buku</td>
                        <td>
                            <div class="flex items-center justify-center gap-1">
                                <a href="{{ route('master.publishers.edit', $publisher) }}" 
                ...
                @empty
                    <tr>
                        <td colspan="4" class="text-center py-8 text-slate-500">
                            ...
                            @if($search)
                                Tidak ada penerbit yang cocok dengan pencarian "{{ $search }}"
                            @else
