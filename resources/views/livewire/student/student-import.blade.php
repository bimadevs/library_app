        ...
        <div class="space-y-6">
            <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul class="text-sm text-blue-700 space-y-1 list-disc list-inside">
                    ...
                    <li>Kolom wajib: nis, nama, tempat_lahir, tanggal_lahir, alamat, kelas, jurusan, jenis_kelamin, tahun_ajaran, telepon</li>
                    <li>Kolom opsional: maks_pinjam (default: 3)</li>
                    <li>Format tanggal: YYYY-MM-DD atau DD/MM/YYYY</li>
                    <li>Jenis kelamin: L (Laki-laki) atau P (Perempuan)</li>
                    <li>Nama kelas, jurusan, dan tahun ajaran harus sesuai dengan data master</li>
                </ul>
            </div>

            <div class="flex items-center gap-4">
                <a href="{{ route('students.import.template') }}" class="btn btn-secondary">
                            ...
                            <tbody class="divide-y divide-emerald-100">
                                @foreach($imported as $item)
                                    <tr>
                                        ...
                                        <td class="px-4 py-2 font-mono">{{ $item['nis'] }}</td>
            ...
            @if(count($skipped) > 0)
                <div class="border border-amber-200 rounded-lg overflow-hidden">
                    <div class="bg-amber-50 px-4 py-3 border-b border-amber-200">
                        <h4 class="font-medium text-amber-800">Data Dilewati - Duplikat NIS ({{ count($skipped) }})</h4>
                    </div>
                    <div class="max-h-48 overflow-y-auto">
                        <table class="w-full text-sm">
