<x-app-layout>
    <div x-data="{ 
        ...
        openEdit(event) {
            ...
            this.categoryName = event.detail.name;
            this.open = true;
        }
    }" 
    x-init="
        ...
        <div class="bg-white rounded-3xl shadow-xl shadow-slate-200/60 overflow-hidden border border-slate-100">
            <div class="p-6 md:p-8">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                    <div>
                        <h3 class="text-2xl font-bold text-slate-800 tracking-tight">Daftar Kategori</h3>
                        <p class="text-slate-500 mt-1">Kelola dan atur kategori buku perpustakaan Anda dengan mudah.</p>
                    </div>
            ...
            <div class="flex min-h-full items-center justify-center p-4 text-center sm:p-0">
                <div x-show="open"
                    ...
                    <div class="bg-white px-6 py-5 border-b border-slate-100 flex items-center justify-between sticky top-0 z-10">
                        <div>
                            <h3 class="text-xl font-bold text-slate-800" id="modal-title" x-text="isEdit ? 'Edit Kategori' : 'Tambah Kategori Baru'"></h3>
                            <p class="text-sm text-slate-500 mt-1" x-text="isEdit ? 'Perbarui informasi kategori yang dipilih.' : 'Tambahkan kategori baru ke koleksi.'"></p>
                        </div>
                    ...
                    <div class="px-6 py-6 bg-slate-50/50">
                        <form :action="formAction" method="POST">
                            ...
                            <div class="space-y-2">
                                ...
                                <p class="text-xs text-slate-500 pl-1">Nama kategori harus unik dan belum terdaftar sebelumnya.</p>
                            </div>
